...
public class Settings extends YamlConfig {
  ...
  public static class TOOLS {
    ...
    public static class PROTOCOL_BLOCKER {
      ...
      @Comment({
          "<min>-<max> means that versions from <min> to <max> have the same protocol version,",
          "so these versions will be considered as one version",
          "",
          "List of versions:",
          "1.7.2-1.7.5, 1.7.6-1.7.10, 1.8-1.8.9, 1.9, 1.9.1, 1.9.2-1.9.3, 1.9.4,",
          ...
          "1.17, 1.17.1, 1.18-1.18.1, 1.18.2, 1.19, 1.19.1-1.19.2, 1.19.3, LATEST",
      })
